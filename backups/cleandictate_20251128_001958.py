"""
CleanDictate - Stage 1, 2, 3 & 4: ASR + Cleaning + Stutter Removal + Grammar/Tone
Real-time speech-to-text using Faster Whisper with Silero VAD
Plus hybrid text cleaning, fuzzy n-gram stutter removal, and T5-based grammar correction
Optimized for RTX 4070 GPU and Indian English accent
"""
